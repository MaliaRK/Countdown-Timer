...
console.log(chalk.italic.underline.yellowBright('\n\t\t"LET SET THE COUNTDOWN TIMER FOR EVENTS"\n'));
const userTime = await inquirer.prompt([
    ...
    {
        message: "Write a message or something special you would like to highlight at the end of an interval? ",
        name: "message",
        type: "input",
    },
    {
...
let conversion = userTime.timer === "Minutes"
